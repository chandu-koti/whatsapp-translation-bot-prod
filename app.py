    ...
    sections = [
        {
            ...
            "rows": [
                {"id": "cat_asian", "title": "📱 Asian Languages", "description": "Japanese, Chinese, Korean, Thai"},
                {"id": "cat_indian", "title": "🇮🇳 Indian Languages", "description": "Hindi, Telugu, Tamil, Punjabi"},
                {"id": "cat_european", "title": "🌍 European Languages", "description": "German, Spanish, French, Italian"},
                {"id": "cat_other", "title": "🌎 Other Languages", "description": "Arabic, Russian"},
...
def send_indian_languages(sender_id: str):
    """Send Indian language selection - PAGE 1 (FIXED - Max 7 items per page)"""
    body_text = """🇮🇳 *INDIAN LANGUAGES (Page 1/2)*
...
Select languages to add:"""
    ...
    sections = [
        ...
        },
        {
            "title": "Navigation",
            "rows": [
                {"id": "ind_page_2", "title": "➡️ Page 2", "description": "More languages"},
                {"id": "menu_categories", "title": "⬅️ Back", "description": "Return"},
                {"id": "done_selecting", "title": "✅ Done", "description": "Finish"}
            ]
        }
...
def send_indian_languages_page2(sender_id: str):
    """Send Indian language selection - PAGE 2 (PUNJABI + OTHERS)"""
    body_text = """🇮🇳 *INDIAN LANGUAGES (Page 2/2)*
    ...
    sections = [
        {
            ...
            "rows": [
                ...
                {"id": "add_pa", "title": "🇮🇳 Punjabi", "description": "ਪੰਜਾਬੀ"},
                {"id": "add_ur", "title": "🇮🇳 Urdu", "description": "اردو"},
                {"id": "add_as", "title": "🇮🇳 Assamese", "description": "অসমীয়া"},
                {"id": "add_or", "title": "🇮🇳 Odia", "description": "ଓଡ଼ିଆ"}
            ]
        },
        {
            "title": "Navigation",
            "rows": [
                {"id": "cat_indian", "title": "⬅️ Page 1", "description": "Go back"},
...
def send_european_languages(sender_id: str):
    """Send European language selection - PAGE 1"""
    body_text = """🌍 *EUROPEAN LANGUAGES (Page 1/2)*
...
Select languages to add:"""
    ...
    sections = [
        ...
        },
        {
            "title": "Navigation",
            "rows": [
                {"id": "cat_european_2", "title": "➡️ Page 2", "description": "More European"},
                {"id": "menu_categories", "title": "⬅️ Back", "description": "Return"},
                {"id": "done_selecting", "title": "✅ Done", "description": "Finish"}
            ]
        }
...
def send_european_languages_page2(sender_id: str):
    ...
    body_text = """🌍 *EUROPEAN LANGUAGES (Page 2/2)*
...
Select more languages:"""
    ...
    sections = [
        ...
        },
        {
            "title": "Navigation",
            "rows": [
                {"id": "cat_european", "title": "⬅️ Page 1", "description": "Go back"},
                {"id": "menu_categories", "title": "⬅️ Categories", "description": "Main menu"},
                {"id": "done_selecting", "title": "✅ Done", "description": "Finish"}
            ]
        }
    ...
    sections = [
        {
            ...
            "rows": [
                ...
                {"id": "preset_india", "title": "🇮🇳 India Full", "description": "Hindi + Telugu + Punjabi"},
                ...
                {"id": "preset_default", "title": "🎯 Default", "description": "Japanese + Hindi + Punjabi"}
            ]
        },
        {
            "title": "Navigation",
...
Clean, no spam!"""
    ...
    elif button_id == "ind_page_2":
        send_indian_languages_page2(sender_id)
    ...
    # Presets
        ...
        user_prefs.set_user_languages(sender_id, ['hi', 'te', 'pa', 'en'])
        whatsapp_handler.send_message(sender_id, "✅ India Full!\n🇮🇳 Hindi + Telugu + Punjabi + English")
        send_done_message(sender_id)
        ...
        user_prefs.set_user_languages(sender_id, ['ja', 'hi', 'pa'])
        whatsapp_handler.send_message(sender_id, "✅ Default!\n🇯🇵 Japanese + 🇮🇳 Hindi + Punjabi")
        send_done_message(sender_id)
...
def process_message(webhook_data):
    """Process incoming WhatsApp messages - 100% LOOP FREE"""
    try:
...
if __name__ == '__main__':
    ...
    logger.info(f"🚀 Starting Bot - PRODUCTION MODE - PUNJABI + FIXED LIMIT!")
